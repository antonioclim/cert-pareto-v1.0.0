...
OpenAI ChatGPT (GPT-5.5 Pro, June 2026) and OpenAI Deep Research (June 2026) were used for early outline drafting, refactoring discussion, checklist construction, style diagnostics and editorial review of documentation and paper prose. The author reviewed, edited, executed and validated all AI-assisted code, tests, mathematical claims, examples, metadata and manuscript text. The author made the software architecture, mathematical, licensing and submission decisions and takes responsibility for the final repository, package and paper.
