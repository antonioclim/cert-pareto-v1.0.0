...
The API reference is in [`docs/API.md`](docs/API.md), and the public quality-assurance record is in [`docs/QUALITY_ASSURANCE.md`](docs/QUALITY_ASSURANCE.md).
...
docs/                API reference and public quality-assurance notes
```
...
The JOSS disclosure section is included in `paper/paper.md`. All code, tests, examples, metadata and documentation in this repository are author-reviewed and test-validated before release.
